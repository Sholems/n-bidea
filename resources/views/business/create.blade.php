...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Create Business Profile</h1>
    <a href="{{ route('business-owner.businesses.index') }}" class="btn btn-outline-secondary">
        <i class="bi bi-arrow-left"></i> Back to List
    </a>
</div>

<form action="{{ route('business-owner.businesses.store') }}" method="POST">
    @csrf
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="trading_name" id="trading_name" class="form-control @error('trading_name') is-invalid @enderror" value="{{ old('trading_name') }}">
                    @error('trading_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="business_type" id="business_type" class="form-select @error('business_type') is-invalid @enderror" required>
                        ...
                        <option value="Limited Liability Company" {{ old('business_type') === 'Limited Liability Company' ? 'selected' : '' }}>Limited Liability Company</option>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="lga" id="lga" class="form-control @error('lga') is-invalid @enderror" value="{{ old('lga') }}" required>
                    @error('lga')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="website" id="website" class="form-control @error('website') is-invalid @enderror" value="{{ old('website') }}" placeholder="https://">
                    @error('website')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="contact_person_name" id="contact_person_name" class="form-control @error('contact_person_name') is-invalid @enderror" value="{{ old('contact_person_name') }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="contact_person_phone" id="contact_person_phone" class="form-control @error('contact_person_phone') is-invalid @enderror" value="{{ old('contact_person_phone') }}">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="cac_number" id="cac_number" class="form-control @error('cac_number') is-invalid @enderror" value="{{ old('cac_number') }}">
                    @error('cac_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="nrs_number" id="nrs_number" class="form-control @error('nrs_number') is-invalid @enderror" value="{{ old('nrs_number') }}">
                    @error('nrs_number')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text" name="nin" id="nin" class="form-control @error('nin') is-invalid @enderror" value="{{ old('nin') }}">
                    @error('nin')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="trade_activity" id="trade_activity" class="form-control @error('trade_activity') is-invalid @enderror" value="{{ old('trade_activity') }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="border_route" id="border_route" class="form-control @error('border_route') is-invalid @enderror" value="{{ old('border_route') }}">
                    @error('border_route')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="d-flex justify-content-end gap-2">
        ...
        <button type="submit" class="btn btn-primary">
            <i class="bi bi-check-lg"></i> Create Business
        </button>
    </div>
</form>
@endsection
